<template>
  <div class="card text-center ms-2 me-2 mt-4">
    <div class="card-header">
      <h2>อาการแย่ลงจากโรค</h2>
      <p>หายใจหอบ</p>
      <p>ทำกิจวัตรประจำวันไม่ได้ตามปกติ</p>
      <p>ไอมากขึ้น</p>
      <p>เสมหะเหนียวข้น</p>
      <p>มีไข้</p>
      <p>นอนไม่หลับ</p>
    ...
    <div class="card-body">
      ...
      <div class="card-text">
        <div>- ใช้ยาตามคำแนะนำของเภสัชกร</div>
        <div>- ใช้ยาสูดฉุกเฉิน __ กด ทุก __ ชั่วโมง</div>
        <div>
          - ใช้ Oxygen
        </div>
        <div>
          - ไปพบแพทย์ถ้าอาการไม่ดีขึ้น
        </div>
      </div>
